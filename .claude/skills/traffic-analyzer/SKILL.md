...
**With SimilarWeb API (see `.claude/affiliate-shared/references/social-data-providers.md`):**
...
- **No API and web_search returns limited data:** Present what's available. Note: *"Limited data available via web search. For accurate metrics, configure SimilarWeb API — see `.claude/affiliate-shared/references/social-data-providers.md`."* Still provide estimated score.
...
- `.claude/affiliate-shared/references/social-data-providers.md` — SimilarWeb API configuration
