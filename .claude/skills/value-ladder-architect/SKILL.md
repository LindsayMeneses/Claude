...
Read `.claude/affiliate-shared/references/offer-frameworks.md` for the Value Ladder framework.
...
- `.claude/affiliate-shared/references/offer-frameworks.md` — Value Ladder framework, pricing psychology
- `.claude/affiliate-shared/references/ftc-compliance.md` — FTC disclosure at every rung
