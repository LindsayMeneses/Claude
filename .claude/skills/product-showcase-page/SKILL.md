...
- "Built with Affiliate Skills by Affitor" footer from `.claude/affiliate-shared/references/affitor-branding.md`
...
- `.claude/affiliate-shared/references/ftc-compliance.md` — Disclosure text for hero and footer. Read in Step 3.
- `.claude/affiliate-shared/references/affitor-branding.md` — Footer attribution HTML. Read in Step 3.
