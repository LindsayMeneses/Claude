...
Read `.claude/affiliate-shared/references/seo-strategy.md` for clustering methodology.
...
- `.claude/affiliate-shared/references/seo-strategy.md` — Topical authority, clustering methodology, hub-and-spoke
