...
- `.claude/affiliate-shared/references/social-data-providers.md` — API configuration and engagement score formula
- `.claude/affiliate-shared/references/flywheel-connections.md` — master flywheel connection map
- `.claude/affiliate-shared/references/platform-rules.md` — platform-specific content guidelines
