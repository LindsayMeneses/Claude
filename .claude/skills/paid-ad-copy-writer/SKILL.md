...
- `.claude/affiliate-shared/references/ftc-compliance.md` — FTC disclosure requirements for paid advertising. Read in Step 4.
- `.claude/affiliate-shared/references/affiliate-glossary.md` — Ad terminology (ROAS, CTR, CPC). Referenced in budget guide.
