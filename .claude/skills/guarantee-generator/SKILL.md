...
Read `.claude/affiliate-shared/references/offer-frameworks.md` for guarantee types.
...
- `.claude/affiliate-shared/references/offer-frameworks.md` — Guarantee types, rules, and examples
- `.claude/affiliate-shared/references/ftc-compliance.md` — FTC rules on guarantee claims
