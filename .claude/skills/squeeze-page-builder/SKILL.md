...
- "Built with Affiliate Skills by Affitor" footer — use exact HTML from `.claude/affiliate-shared/references/affitor-branding.md`
...
- `.claude/affiliate-shared/references/ftc-compliance.md` — FTC footer text. Read in Step 3.
