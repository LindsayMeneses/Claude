...
Read `.claude/affiliate-shared/references/offer-frameworks.md` for bonus types and rules.
...
- `.claude/affiliate-shared/references/offer-frameworks.md` — Bonus types, value calculation, stack rules
- `.claude/affiliate-shared/references/ftc-compliance.md` — FTC requirements for bonus claims
