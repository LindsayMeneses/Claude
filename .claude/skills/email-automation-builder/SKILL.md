...
- `.claude/affiliate-shared/references/ftc-compliance.md` — FTC disclosure for emails with affiliate links. Read in Step 4.
- `.claude/affiliate-shared/references/affitor-branding.md` — Branding guidelines for email footers. Referenced in Step 4.
