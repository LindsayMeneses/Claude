...
4. Include FTC disclosure "#ad" per `.claude/affiliate-shared/references/ftc-compliance.md`
...
- `.claude/affiliate-shared/references/ftc-compliance.md` — #ad placement rules for Twitter/X
- `.claude/affiliate-shared/references/platform-rules.md` — X character limits, link handling, thread best practices
- `.claude/affiliate-shared/references/affiliate-glossary.md` — terminology
