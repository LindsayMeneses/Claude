...
Read `.claude/affiliate-shared/references/offer-frameworks.md` for the Hormozi framework.
...
- `.claude/affiliate-shared/references/offer-frameworks.md` — Hormozi Value Equation, bonus stack rules, guarantee types, pricing psychology
- `.claude/affiliate-shared/references/ftc-compliance.md` — FTC disclosure requirements (no income claims, no fake urgency)
- `.claude/affiliate-shared/references/affiliate-glossary.md` — Affiliate terminology
- `.claude/affiliate-shared/references/flywheel-connections.md` — Master connection map
