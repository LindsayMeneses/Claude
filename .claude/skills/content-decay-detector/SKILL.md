...
Read `.claude/affiliate-shared/references/seo-strategy.md` for decay signals and refresh methodology.
...
- `.claude/affiliate-shared/references/seo-strategy.md` — Decay signals, refresh methodology, priority matrix
