...
- `.claude/affiliate-shared/references/social-data-providers.md` — data sources for infographic content
- `.claude/affiliate-shared/references/platform-rules.md` — platform-specific image requirements
