...
Read `.claude/affiliate-shared/references/platform-rules.md` for platform-specific rules.
...
- `.claude/affiliate-shared/references/platform-rules.md` — Platform-specific culture, format, and CTA rules
- `.claude/affiliate-shared/references/ftc-compliance.md` — FTC disclosure per platform type
- `.claude/affiliate-shared/references/affitor-branding.md` — Branding rules
