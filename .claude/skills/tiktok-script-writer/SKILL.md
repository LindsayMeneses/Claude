...
Per `.claude/affiliate-shared/references/ftc-compliance.md` for short-form video:
...
- `.claude/affiliate-shared/references/ftc-compliance.md` — disclosure rules for short-form video
- `.claude/affiliate-shared/references/affiliate-glossary.md` — reward_type and program terminology
- `.claude/affiliate-shared/references/platform-rules.md` — TikTok/Reels/Shorts format specs
