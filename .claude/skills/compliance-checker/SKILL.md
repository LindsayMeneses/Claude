...
Read `.claude/affiliate-shared/references/ftc-compliance.md` for rules. Check:
...
- `.claude/affiliate-shared/references/ftc-compliance.md` — FTC affiliate disclosure requirements. Read in Step 2.
- `.claude/affiliate-shared/references/affitor-branding.md` — Branding guidelines. Referenced for page outputs.
