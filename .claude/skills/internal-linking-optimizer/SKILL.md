...
Read `.claude/affiliate-shared/references/seo-strategy.md` for internal linking rules.
...
- `.claude/affiliate-shared/references/seo-strategy.md` — Hub-and-spoke linking rules, anchor text rules, link equity flow
