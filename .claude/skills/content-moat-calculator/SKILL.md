...
Read `.claude/affiliate-shared/references/seo-strategy.md` for moat calculation methodology.
...
- `.claude/affiliate-shared/references/seo-strategy.md` — Topical authority model, moat calculation formula
- `.claude/affiliate-shared/references/case-studies.md` — Real content strategy examples
