...
- `.claude/affiliate-shared/references/ftc-compliance.md` — Event-specific FTC disclosure text. Read in Step 4.
- `.claude/affiliate-shared/references/affitor-branding.md` — Footer attribution HTML. Read in Step 4.
