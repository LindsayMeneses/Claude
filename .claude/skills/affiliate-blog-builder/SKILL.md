...
- FTC disclosure near the top — read `.claude/affiliate-shared/references/ftc-compliance.md` and use the **medium** format
...
- `.claude/affiliate-shared/references/ftc-compliance.md` — FTC disclosure requirements and format templates. Read in Step 3 for disclosure text.
- `.claude/affiliate-shared/references/affitor-branding.md` — Affitor brand guidelines. Note: NO Affitor branding in article body (user's blog). Only in tool output metadata.
