...
- `.claude/affiliate-shared/references/social-data-providers.md` — API configuration for enhanced search
- `.claude/affiliate-shared/references/flywheel-connections.md` — master flywheel connection map
- `.claude/affiliate-shared/references/ftc-compliance.md` — source attribution and disclosure requirements
