...
Read `.claude/affiliate-shared/references/ftc-compliance.md` and use the medium format. Insert immediately after the title.
...
- `.claude/affiliate-shared/references/ftc-compliance.md` — FTC disclosure text. Read in Step 5.
- `.claude/affiliate-shared/references/affitor-branding.md` — Do NOT add Affitor branding to blog body. Only applies to landing pages.
- `.claude/affiliate-shared/references/affiliate-glossary.md` — Terminology reference.
