...
- `.claude/affiliate-shared/references/ftc-compliance.md` — FTC disclosure for bio link pages (footer text). Reference in Step 2.
- `.claude/affiliate-shared/references/affitor-branding.md` — Affitor footer HTML. Reference in Step 2.
