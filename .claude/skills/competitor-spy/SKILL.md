...
**With API (optional — see `.claude/affiliate-shared/references/social-data-providers.md`):**
...
- `.claude/affiliate-shared/references/affiliate-glossary.md` — affiliate link pattern reference
- `.claude/affiliate-shared/references/ftc-compliance.md` — understanding competitor disclosures
